...
export default function Sidebar() {
  ...
  return (
    <>
      <div className='w-48 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white mr-6 mt-2'>
        <Link
          href='/knowledge'
